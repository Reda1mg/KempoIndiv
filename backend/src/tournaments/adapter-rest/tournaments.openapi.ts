...
export const TournamentsRoutes = {
    ...
    // route to get by user_id
    getTournamentByUser: createRoute({
        method: 'get',
        path: '/competitors/{user_id}',
        summary: 'Get Tournament by user',
        description: 'Get Tournament by user',
        request: {
            params: z.object({
                user_id: z.string()
            })
        ...
        responses: {
            200: {
                ...
                user_id:z.optional(z.coerce.number())
            }))
                    }
                }
            },
