...
const Filter = ({
  ...
  const canAdd = userRole === "ADMIN" || userRole === "GESTIONNAIRE";

  return (
    <div className={styles.filtersContainer}>
      <div className={styles.filterItem}>
        <label htmlFor="search"><span>🔎</span> Rechercher:</label>
        <input
          type="text"
          id="search"
      ...
      <div className={styles.filterItem}>
        <label htmlFor="gradeFilter"><span>🏆</span> Filtrer par grade :</label>
        <select
          id="gradeFilter"
          value={selectedGrade}
